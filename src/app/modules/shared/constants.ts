...
export enum i18nRU {
    ...
    POST  = 'Администратор',
    FORM_ADD_TITLE_INSTRUCTOR = 'Добавить нового инструктора',
    FORM_EDIT_TITLE_INSTRUCTOR = 'Редактировать профиль инструктора',
    FORM_DATE = 'Дата',
    FORM_EDIT_TITLE_VISITER = 'Редактировать профиль посетителя',
    FORM_ADD_TITLE_VISITER = 'Добавить нового посетителя',
...
export enum i18nErrors {
    ...
    ERROR_EMPTY_DATE_START = 'Необходимо заполнить дату начала действия',
    ERROR_EMPTY_DATE_END = 'Необходимо заполнить дату завершения действия',
    ERROR_COST_PAST = 'Необходимо заполнить стоимость',
